...
const EXAM_CTA = {
  ...
  description: "Таймер, 100 вопросов, анализ ошибок и итоговый балл — как на настоящем экзамене. Без регистрации.",
  features:    ["100 вопросов", "160 минут", "ТГО", "Английский язык"],
